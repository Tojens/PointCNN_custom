...
CUDA_VISIBLE_DEVICES=$gpu python3 ../test_general_seg.py -t /mnt/edisk/PointCNN/data/semantic3d/val_data_files.txt -l $ckpt -m pointcnn_seg -x $setting -r $repeat $save_ply
